...
local driftKey = options:addKeyBind("DriftKey", DRIFT_BINDING, Keyboard.KEY_LSHIFT,
    "Default: Left Shift. Hold with steering at 20-100 km/h for drift without handbrake. Gear-shift combinations take priority in manual mode.")
driftKey.shift = false
driftKey.ctrl = false
driftKey.alt = false
local rearAxleDrift = options:addTickBox("RearAxleDrift", "Experimental rear-axle drift (Shift only)", true,
    "Rear tires lose grip while front tires retain their existing grip. No added body torque. Uncheck to restore the 0.4.18 drift model. Handbrake and other slide modes are unchanged.")
local rearAxleGrip = options:addSlider("RearAxleGrip", "Experimental drift: rear grip multiplier", 0.25, 1.0, 0.05, 0.45,
    "Multiplier of the rear tires' current grip. Lower = easier rear slip; 1.0 = no added grip loss. Does not repair worn tires or alter suspension. Power-drift rotation/grip settings do not affect this experiment.")
...
local function applyOptions()
    ...
    callJava("configureRearAxleDrift", rearAxleDrift:getValue(), rearAxleGrip:getValue())
