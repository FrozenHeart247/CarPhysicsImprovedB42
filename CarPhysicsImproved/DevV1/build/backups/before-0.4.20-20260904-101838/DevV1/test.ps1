...
Write-Host 'All V1 drivetrain, driver-traits, drift-key, slide, terrain, tire-effects, cabin-weather, tire-renderer, Lua syntax and installed-game ABI tests passed.'
